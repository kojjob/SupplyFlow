...
class OrderItemsTest < ApplicationSystemTestCase
  ...
  test "should create order item" do
    ...
    fill_in "Discount amount", with: @order_item.discount_amount
    fill_in "Metadata", with: @order_item.metadata
    fill_in "Notes", with: @order_item.notes
    ...
    fill_in "Shipped quantity", with: @order_item.shipped_quantity
    fill_in "Tax amount", with: @order_item.tax_amount
    fill_in "Tax rate", with: @order_item.tax_rate
    fill_in "Total amount", with: @order_item.total_amount
